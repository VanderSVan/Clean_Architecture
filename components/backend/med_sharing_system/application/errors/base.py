...
class ErrorMeta(type):
    ...
    def __new__(mcs, name, bases, dct):
        ...
        if 'namespace' in dct:
            ...
            namespace = mcs.get_namespace(mcs, bases)
...
class BaseError(Exception):
    """
    Базовый класс для ошибок логики приложения.
    """
...
class ErrorsList(BaseError):
    """
    Класс для ситуаций, когда приложение
    должно отправить много ошибок одновременно.
    """
